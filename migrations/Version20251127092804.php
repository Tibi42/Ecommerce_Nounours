 ...
 */
final class Version20251127092804 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE category ADD is_approved TINYINT(1) NOT NULL, ADD author_email VARCHAR(150) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE category DROP is_approved, DROP author_email');
